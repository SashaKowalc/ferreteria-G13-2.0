    ...
    const expresiones = {
        ...
        direccion: /^[a-zA-Z0-9-ZÀ-ÿ\s]{1,40}$/, // Letras y espacios, pueden llevar acentos.
    ...
    const validarContraseña2 = () => {
        ...
        console.log("La contraseña es: " + inputPassword1)
        console.log("La repetirContraseña es: " + inputPassword2)
